...
proc set_LEDs {send_data} {
    ...
    set tdi [device_virtual_dr_shift -dr_value $send_data -instance_index 0  -length 16]
	#Use this if you want to read back the tdi while you shift in the new value
	
    device_virtual_dr_shift -dr_value $send_data -instance_index 0  -length 16 -no_captured_dr_value
...
proc IncomingData {sock} {
    ...
    if {$data_len != "0"} then {
        ...
        set line [string range $line 0 15]
